...
public class InstructionAddQ : BaseInstruction
{
    private const string InstructionName = "ADDQ";
    private const int InstMask = 0b1111_0001_0000_0000;
    private const int InstMaskTarget = 0b0101_0000_0000_0000;
    
    private string _size;
    private int _data;
    private BaseAddress _source;

    public InstructionAddQ(Hunk hunk, int hunkSectionNumber, ref int pc) : base(hunk, hunkSectionNumber, ref pc)
    {
    }
